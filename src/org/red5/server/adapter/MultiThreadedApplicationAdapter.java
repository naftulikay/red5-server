...
public class MultiThreadedApplicationAdapter extends StatefulScopeWrappingAdapter implements
		...
		ISubscriberStreamService, ISchedulingService, IStreamAwareScopeHandler {

	/**
	 * Logger object
	 */
	protected static Log log = LogFactory.getLog(MultiThreadedApplicationAdapter.class.getName());

	/**
	 * List of application listeners.
	 */
	private Set<IApplication> listeners = new CopyOnWriteArraySet<IApplication>();

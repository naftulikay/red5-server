...
public interface IM4A extends IStreamableFile {
	...
	/**
	 * Returns a boolean stating whether the m4a has metadata
	 * 
	...
	/**
	 * Returns a boolean stating whether a m4a has keyframedata
	 * 
	...
	/**
	 * Sets the keyframe data of a m4a file
	 * 
	...
	/**
	 * Refreshes the headers. Usually used after data is added to the m4a file
	 * 

...
public class AMF3 {
	...
	// assume it is for the time beeing..
	 ...
	 * The property name should be declared in the class-def reference but this
	 * doesn’t seem <b /> to always be the case - more to come here.
	 */
	 ...
	 * If there is a class-def reference there are no property names and the
	 * number of values <br />

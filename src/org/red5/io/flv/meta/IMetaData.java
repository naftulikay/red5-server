 ...
 * 
 * Sample Data: private boolean canSeekToEnd = true; private int videocodecid =
 * 4; private int framerate = 15; private int videodatarate = 400; private int
 * height = 215; private int width = 320; private int duration = 7.347;
 */

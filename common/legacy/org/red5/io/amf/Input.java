...
import org.red5.server.common.service.ConversionUtils;
...
public class Input extends BaseInput implements org.red5.io.object.Input {
	...
	public String readString() {
		...
		final String string = AMF.CHARSET.decode(buf.buf()).toString();
	 ...
	 */
	public static String getString(BufferEx buf) {
		int len = buf.getShort() & 0x0ffff;
		int limit = buf.limit();
	...
	public Object readReference() {
		if (referenceMode == ReferenceMode.MODE_RTMP) {
			return getReference((buf.getShort() & 0x0ffff) - 1);
		} else {
			return getReference(buf.getShort() & 0x0ffff);
		}
	}

...
/**
 * MP4Header parses out the contents of a MP4 video file and returns
 * the Header data 
 *
...
public class MP4Header {
	...
	/**
	 * Overrides the toString method so that a MP4Header can
	 ...
	 *
	 * @return boolean      <code>true</code> if this MP4 header contains audio data, <code>false</code> otherwise
	 */
	...
	/**
	 * Sets the audio flag on whether this data contains audio
	 *
	 * @param flagAudio     <code>true</code> if this MP4 header contains audio data, <code>false</code> otherwise
	 */
	 ...
	 *
	 * @return boolean          <code>true</code> if this MP4 header contains video data, <code>false</code> otherwise
	 */
	 ...
	 * Sets the audio flag on whether this data contains audio
	 *
	 * @param type_flags_video  <code>true</code> if this MP4 header contains video data, <code>false</code> otherwise
	 */
	 ...
	 *
	 * @param version           MP4 version byte
	 */
